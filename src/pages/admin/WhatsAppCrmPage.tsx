            ...
            <div className="grid gap-5">
              ...
              {automationSettings && settingsOpen ? (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                  ...
                  <p className="mt-1 text-[10px] leading-4 text-[var(--color-copy)]">Para enviar el archivo .ics fuera de la ventana de 24 h, esta plantilla aprobada por Meta debe tener encabezado de tipo Documento.</p>
