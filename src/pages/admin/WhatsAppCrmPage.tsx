            ...
            <div className="grid gap-5">
              ...
              {automationSettings && settingsOpen ? (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                  ...
                  <p className="mt-1 text-[10px] leading-4 text-[var(--color-copy)]">Con encabezado Documento, Meta adjunta el .ics fuera de la ventana de 24 h. Sin él, la plantilla envía un enlace seguro que descarga el mismo archivo.</p>
