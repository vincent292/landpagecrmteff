...
begin
  if tg_op = 'INSERT' and exists (
    ...
    where count.status = 'abierto'
      ...
      and not (
        new.movement_type = 'conteo'
        and new.reference = count.id::text
      )
  ) then
...
begin
  ...
  loop
    ...
    set expected_stock = opening_counted_stock,
        ...
        difference_stock = 0,
        opening_notes = case
          when coalesce(opening_difference_stock, 0) <> 0
